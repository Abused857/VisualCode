    ...
    <form wire:submit="login">
        ...
        <div class="-mx-3 flex flex-1 justify-center">
            <div class="grid grid-cols-2">
                ...
                <a href="/socialite/twitch"  class="px-3 py-2">

                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-twitch" viewBox="0 0 16 16">
                ...
                <a href="/socialite/twitter"  class="px-3 py-2">
                ...
                <a href="/socialite/linkedin"  class="px-3 py-2">
